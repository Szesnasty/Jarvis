...
5. **Note content fetching.** The top 3 results are read from disk. Each note's content is hard-truncated at 500 characters. Failures are silently skipped so a missing note never blocks a response.
